...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		function initFSGui() { //refresh the fs 
...
<div align="center" class="bg"><div style="width: 800px;">
	...
	<tr>
		<td height="25" width="800">
			<div align="center">
				<div>
					<b class="rcornrs">
					<b class="rcornrs1"><b></b></b>
					<b class="rcornrs2"><b></b></b>
					<b class="rcornrs3"></b>
					<b class="rcornrs4"></b>
					<b class="rcornrs5"></b></b>
	...
	<div id="rndedbottom"style="margin-top: -25px;">
		<b class="rcornrsbot">
		<b class="rcornrsbot1"><b></b></b>
		<b class="rcornrsbot2"><b></b></b>
		<b class="rcornrsbot3"></b>
		<b class="rcornrsbot4"></b>
		<b class="rcornrsbot5"></b></b>

		<div class="rcornrsbotfg">
			&nbsp;
		</div>

		<b class="rcornrsbot">
		<b class="rcornrsbot5"></b>
		<b class="rcornrsbot4"></b>
		<b class="rcornrsbot3"></b>
		<b class="rcornrsbot2"><b></b></b>
		<b class="rcornrsbot1"><b></b></b></b>
	</div>
	...
	<iframe NAME="h_form_change_directory"> height="0" width="0" frameborder="no"</iframe>
	<iframe NAME="h_form_upload_file"> height="0" width="0" frameborder="no"</iframe>
	<iframe NAME="h_form_delete_file"> height="0" width="0" frameborder="0"></iframe>
	<iframe NAME="h_fsgui_fetch"> height="0" width="0" frameborder="0"></iframe>
	<iframe NAME="h_fsgui_generic"> height="0" width="0" frameborder="0"></iframe>
